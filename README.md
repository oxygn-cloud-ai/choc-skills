...
| **project** | v1.2.11 | `/project` | Project repository administration — create, audit, configure, status check with multi-session workflow scaffolding | [README](skills/project/README.md) |
