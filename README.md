...
| **chk2** | v2.1.0 | `/chk2` | Adversarial security audit for web services — 209 checks across 30 categories | [README](skills/chk2/README.md) |
| **rr** | v4.0.0 | `/rr` | Risk register assessment — interactive 6-step workflow or autonomous batch mode | [README](skills/rr/README.md) |
