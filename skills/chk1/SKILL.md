...
```
chk1 v2.4.10 — Adversarial Implementation Audit
...
USAGE
  ...
  /chk1 update              Update chk1 to the latest version
...
MODES
  ...
  update         Update chk1 from the GitHub repo
...
| `update` | Run `/chk1:update` — update chk1 to the latest version |
