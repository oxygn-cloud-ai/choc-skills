...
```
chk2 v2.3.26 — Adversarial Security Audit
...
8. Verify sub-command files exist: `ls ${CLAUDE_CONFIG_DIR:-$HOME/.claude}/commands/chk2/*.md`
...
4. **Sub-commands installed**: `ls ${CLAUDE_CONFIG_DIR:-$HOME/.claude}/commands/chk2/*.md` finds files. If not:
