...
3. **Configuration is explicit.** Skills require configuration by the user and by the project. No hidden defaults that silently change behavior. The user and project CLAUDE.md / GITHUB_CONFIG.md are the authoritative sources of truth for how a skill behaves in context.
